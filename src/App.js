...
function App() {
  ...
  return (
    <div className='container-fluid'>
      <Header/>
      <div className='row'>
        <main className='row body-color p-4  justify-content-center'>
          <div className='col-12 col-xl-8 col-md-12 pt-5 pb-5'id="#brief" >
          ...
          <div id="about" className='col-12 col-xl-9 col-md-12 pt-5 pb-5 mt-5 mb-5 pt-5 pb-5' >
          ...
          <div id="work" className='col-12 col-xl-9 col-md-12 mt-5 mb-5 pt-5 pb-5' >
